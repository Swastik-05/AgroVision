    ...
    for file in farm_files:
        try:
            ...
            if "Item Name" in df.columns and "Details" in df.columns:
                ...
                print(f"âš ï¸ Missing required columns in {file}")
...
7. Suggest eco-friendly ways to control pest attacks.
 ...
 give all the above ND Keep it short and simple â€” max 2 OR 3 lines. Speak in friendly language a farmer can easily understand. Do not use asterisks or any other special marks.Use friendly farmer-style INDIAN language   
 Avoid use of special characters astricks(*)
