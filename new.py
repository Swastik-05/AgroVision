...
import base64
from io import BytesIO # bytes ki form me krnaa imaghe ko
...
genai.configure(api_key="AIzaSyB2TvHIt8HsoiKuURmb7jme5IvF1JbBXF8")  #gemini api

def read_all_farm_data():
    farm_files = ["plant_fertilizer.xlsx", "irrigation_schedule.xlsx", "pesticide_recommendations.xlsx"]#data excell file
    all_items = []
    ...
    try:
        ...
        for idx, image_data in enumerate(image_list):
            try:
                ...
                prompt = f"""
 Avoid use of special characters like asterisks.You are an expert AI agriculture advisor helping a farmer by analyzing field or any plant conditions from the image in steps.
 Use friendly farmer-style INDIAN language  Tasks: Avoid use of special characters astricks(*)

Tasks: Avoid use of special characters astricks(*)
1. Identify the type of plants or crops visible.
2. Detect dryness, pest attack, discoloration, or other signs of stress.
 Recommend eco-friendly pesticides and their benefits.important 
...
7. Suggest eco-friendly ways to control pest attacks.
 ...
 give all the above ND Keep it short and simple — max 2 OR 3 lines. Speak in friendly language a farmer can easily understand. Do not use asterisks or any other special marks.Use friendly farmer-style INDIAN language   
